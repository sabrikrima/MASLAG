...
//        int a = sc.nextInt();
       ...
       int jj=31 ; int yy=1998 ; int mm=8;
        ...
        User u = new User(b,c,d,e,f,g,h,dd);
      try {
      String sql = "insert into user (Nom_User,Prenom_User,Cin_User,Num_User,Adresse_User,Email_User,Role_User,Date_N_User)" + "values(?,?,?,?,?,?,?,?)";
      ste=cnx.prepareStatement(sql);
       
      ste.setString(1, u.getNom_User());
      ste.setString(2, u.getPrenom_User());
      ste.setInt(3,u.getCin_User());
      ste.setInt(4,u.getNum_User());
      ste.setString(5,u.getAdresse_User());
      ste.setString(6,u.getEmail_User());
      ste.setString(7,u.getRole_User());
      ste.setDate(8, u.getDate_N_User());
